...
The bounded Type 2, Type 4, and Type 12 paths currently expose a logical active-high DM
...
Type 2, Type 4, and Type 12 attachments now accept descriptors only at state 8-to-1
