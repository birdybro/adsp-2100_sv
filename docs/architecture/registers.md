...
general-MOVE sources remains open as OQ-016; Type 3 writes and Type 17 moves
expose their provisional zero-extension choice explicitly. A bounded sequencer slice connects
...
recognition timing, and whole-core instruction decode are not part of this
increment; DIVS and DIVQ exist only in bounded Type 24/23 slices.
