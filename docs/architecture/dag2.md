...
at acknowledgment. Its native attachment and fetched Type 2/3/4/12 composition
preserve that completion rule; the fetched run covers all 32 cross-DAG Type 4
and Type 12 I/M selections, including DAG2 linear/circular updates, among 2,057
Type 4 and 119 Type 12 transactions. Other PM/DM multifunction updates remain
unimplemented
...
within 51,587 clocks: a known I4/M4 Type 21 result supplies the next Type 13 PM
...
Original Type 1 execution fixes its PM address to DAG2 and exposes all
...
context. The bounded logical slice captures the DAG2 descriptor beside DAG1
and commits both selected-I postmodifications atomically with the two loads,
PX, and optional compute/status result. Its 51,069-clock comparison covers
every compute-field tuple, both banks, linear/circular updates, and held
packets. Native PM/DM phase attachment remains open under OQ-023 rather than
assuming how a DMACK extension affects the PM read
