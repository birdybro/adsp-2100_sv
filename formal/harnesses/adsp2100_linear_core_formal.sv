...
module adsp2100_linear_core_formal (
    ...
    always_comb begin
        ...
        cover (
            retire_event && ((opcode & 24'hf80000) == 24'h280000)
        );
        cover (
        ...
        cover (
            retire_event && ((opcode & 24'hffe0ff) == 24'h060000)
        ...
        cover (
            retire_event && ((opcode & 24'hffffe0) == 24'h090000)
        );
        cover (
            retire_event && ((opcode & 24'hffffe0) == 24'h040000)
        );
    end
