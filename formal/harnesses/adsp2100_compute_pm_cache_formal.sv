...
module adsp2100_compute_pm_cache_formal (
    input logic clk,
    input logic reset,
    input logic execute,
    ...
    logic af_valid_unused;
    logic [15:0] mf_unused;
    logic mf_valid_unused;
    logic [39:0] mr_unused;
    logic mr_valid_unused;
    ...
    adsp2100_compute_pm_cache_slice dut (
        .clk_i(clk),
        .reset_i(reset),
        .execute_i(execute),
        .opcode_i(opcode),
        ...
        .af_o(af_unused),
        .af_valid_o(af_valid_unused),
        .mf_o(mf_unused),
        .mf_valid_o(mf_valid_unused),
        .mr_o(mr_unused),
        .mr_valid_o(mr_valid_unused),
    ...
    assign unused_observation = ^{
        ...
        probe_l_valid_unused, px_unused, px_valid_unused, af_unused,
        af_valid_unused, mf_unused, mf_valid_unused, mr_unused,
        mr_valid_unused, astat_unused, astat_valid_mask_unused,
