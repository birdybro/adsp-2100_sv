...
module adsp2100_shifter_dm_native_slice (
    input  logic        clk_i,
    input  logic        reset_i,
    ...
    adsp2100_shifter_dm_slice core (
        .clk_i(clk_i),
        .reset_i(reset_i),
        ...
        .shifter_result_known_o(shifter_result_known_o),
        ...
        .sr_write_o(sr_write_o),
        .se_write_o(se_write_o),
        .sb_write_o(sb_write_o),
        .ss_write_o(ss_write_o),
