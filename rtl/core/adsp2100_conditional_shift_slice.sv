...
module adsp2100_conditional_shift_slice (
    input  logic        clk_i,
    input  logic        reset_i,
    ...
    assign sr_write_o = boundary_valid_o && condition_true_o && raw_sr_write;
    assign se_write_o = boundary_valid_o && condition_true_o && raw_se_write;
    assign sb_write_o = boundary_valid_o && condition_true_o && raw_sb_write;
    assign ss_write_o = boundary_valid_o && condition_true_o && raw_ss_write;
