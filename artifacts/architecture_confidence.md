...
| Opcode field/function legality | UNKNOWN | class masks, field positions, finite code tables, register codes, Type 17/Type 26 action selection, and NOP/Type 6/Type 16/Type 18/Type 21/Type 25 semantics are closed within their explicit unsupported boundaries; Type 14 is bounded to 25,648 canonical packets and Type 15 to 14,336 source-closed words; remaining legal combinations and instruction effects are not |
...
| Parallel old/new-value semantics | CORROBORATED, BOUNDED | Type 14 cycle-start reads and cycle-end noncolliding writes are supported by the original manual and explicit later-family corroboration and pass all 25,648 canonical packets in both banks; other multifunction classes, original same-destination behavior, and memory-access ordering remain unresolved |
