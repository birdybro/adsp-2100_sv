...
| Opcode field/function legality | UNKNOWN | class masks, field positions, finite code tables, register codes, Type 17/Type 26 action selection, and NOP/Type 6/Type 18/Type 21/Type 25 semantics are closed; Type 15 is source-closed only for 14,336 words; remaining legal combinations and instruction effects are not |
