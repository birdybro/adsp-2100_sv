...
| Opcode field/function legality | UNKNOWN | class masks, field positions, finite code tables, register codes, NOP/Type 18/Type 25 semantics, and bounded Type 26 action selection are closed; remaining legal combinations and instruction effects are not |
