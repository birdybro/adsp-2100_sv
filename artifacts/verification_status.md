...
| Formal harnesses | SYNTAX PASS, PROOFS NOT RUN | 35 recipes, including bounded Type 6/Type 8/Type 9/Type 10/Type 11/Type 14/Type 15/Type 16/Type 17/Type 19/Type 20/Type 21 and phase-aware Type 22 action decode/state execution, pass strict assertion syntax lint; SymbiYosys/Yosys unavailable |
| Register encoding metadata | PASS, PARTIAL | 4 tests; all 64 RGP/REG positions accounted |
| Assembler/disassembler | PASS, PARTIAL | 29 tests; NOP, all Type 6 immediate/DREG forms, 20,513 representative Type 8 canonical packets plus raw supported aliases, all 21,920 canonical Type 9 forms plus raw aliases, all 507,904 supported Type 10 direct and 124 supported Type 19 indirect JUMP/CALL forms, all 262,144 Type 11 DO UNTIL forms, all 32 Type 20 RTS/RTI and 16 Type 22 TRAP forms, all 25,648 canonical Type 14 packets, 280 Type 15 and 1,792 Type 16 syntax forms, parameterized Type 18, all 2,256 legal Type 17 pairs, all 32 Type 21 selections, exact Type 25, and raw alias words round trip; CALL NOT CE and other unsupported/conflicting/reserved forms fail closed |
...
Type 15, Type 16, Type 17, Type 18, Type 19, Type 20, Type 22,
...
58,248 Type 18, and 50,124 Type 21 stateful cycles.
