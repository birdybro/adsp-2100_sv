...
| Formal harnesses | SYNTAX PASS, PROOFS NOT RUN | 36 recipes, including bounded Type 6/Type 8/Type 9/Type 10/Type 11/Type 14/Type 15/Type 16/Type 17/Type 19/Type 20/Type 21/Type 24 and phase-aware Type 22 action decode/state execution, pass strict assertion syntax lint; SymbiYosys/Yosys unavailable |
| Register encoding metadata | PASS, PARTIAL | 4 tests; all 64 RGP/REG positions accounted |
| Assembler/disassembler | PASS, PARTIAL | 31 tests; NOP, all Type 6 immediate/DREG forms, 20,513 representative Type 8 canonical packets plus raw supported aliases, all 21,920 canonical Type 9 forms plus raw aliases, all 507,904 supported Type 10 direct and 124 supported Type 19 indirect JUMP/CALL forms, all 262,144 Type 11 DO UNTIL forms, all 32 Type 20 RTS/RTI, 16 Type 22 TRAP, and 16 source-closed Type 24 DIVS forms, all 25,648 canonical Type 14 packets, 280 Type 15 and 1,792 Type 16 syntax forms, parameterized Type 18, all 2,256 legal Type 17 pairs, all 32 Type 21 selections, exact Type 25, and raw alias words round trip; CALL NOT CE and other unsupported/conflicting/reserved forms fail closed |
...
| Semantic decode completeness | IMPLEMENTING | NOP, Type 6, Type 9, Type 11, Type 18, Type 20, Type 21, Type 22, and exact Type 25 have class-complete source-backed semantic entries; Type 24 has 16 bounded actions and 16 explicit unsupported YOP words; Type 10 has 507,904 bounded words and 16,384 explicit OQ-012 words; Type 19 has 124 bounded words and four explicit OQ-012 words; Type 8 has 476,672 bounded packets and 47,616 explicit unresolved/collision words; Type 14 has 25,648 bounded canonical packets and 39,888 explicitly classified unsupported words; Type 15 has 14,336 bounded words and 18,432 explicit unsupported subencodings; Type 16 has 1,792 bounded words and 256 explicit unavailable-XOP subencodings; Type 17 and Type 26 action selection/state execution are exact except Type 17's flagged OQ-016 hypothesis; remaining classes and whole-core integration are incomplete |
| Instruction execution RTL | IMPLEMENTING, BOUNDED | Type 6, Type 8, Type 9, Type 10, Type 11, Type 14, Type 15, Type 16, Type 17, Type 18, Type 19, Type 20, Type 21, Type 22, Type 24, Type 25, and Type 26 state slices execute sourced actions, but no integrated fetch/decode/bus core exists; Type 22 is the first phase-aware slice and does not yet supply general system control |
| Differential testing | PASS, PARTIAL | independent-model comparison covers 50,204 Type 6, 983,386 Type 8, 283,996 Type 9, 554,412 Type 10, 554,309 Type 11, 82,597 Type 14, 58,709 Type 15, 54,403 Type 16, 59,430 Type 17, 58,248 Type 18, 50,259 Type 19, 50,254 Type 20, 50,168 Type 22 clocks, 50,109 Type 24, 50,124 Type 21, 50,112 Type 25, and 50,015 Type 26 stateful cycles; no whole-core or MAME execution harness exists |
| Hard Drivin' synthetic tests | NOT STARTED | no board wrapper exists |

The implemented foundation regression is `make test`: 394 distinct Python
checks plus exhaustive 16,777,216-word class decode, the 2,048-vector
Type 26 action-decode pass, the exhaustive Type 6, Type 8, Type 9, Type 10, Type 11, Type 14,
Type 15, Type 16, Type 17, Type 18, Type 19, Type 20, Type 22, Type 24,
...
regressions, 50,022 CNTR cycles, 50,014 bounded sequencer-integration cycles,
...
Type 10, 554,309 Type 11, 82,597 Type 14, 58,709 Type 15, 54,403 Type 16,
59,430 Type 17, 50,259 Type 19, 50,254 Type 20, 50,168 Type 22 clocks,
50,109 Type 24, 58,248 Type 18, and 50,124 Type 21 stateful cycles.
