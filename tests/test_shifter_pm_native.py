...
class ShifterPMNativeTests(unittest.TestCase):
    ...
    def test_edge_irq_waits_for_uncached_recovery_completion(self) -> None:
        ...
        baseline = apply_shifter_pm_native_cycle(
            _setup_state(),
            phase=LogicalPhase.STATE_7,
            irq_n=0xF,
            icntl=icntl,
        ...
        blocked = apply_shifter_pm_native_cycle(
            state,
            phase=LogicalPhase.STATE_7,
            pmd_read_data=ExactWord(24, 0xBEEF12),
            irq_n=0xB,
        ...
        recovery = apply_shifter_pm_native_cycle(
            blocked.state,
            phase=LogicalPhase.STATE_8,
            irq_n=0xB,
            icntl=icntl,
        ...
        serviced = apply_shifter_pm_native_cycle(
            state,
            phase=LogicalPhase.STATE_7,
            pmd_read_data=ExactWord(24, 0x654321),
            irq_n=0xB,
