...
internal MOVE source/destination pairs, all 14,336 supported Type 15 immediate
...
retire phases, with 177,167 model/RTL phase clocks and an explicit OQ-016
provisional-source retirement pulse; a bounded normal-BR/BG attachment adds
50,003 clocks and 92 complete current-fetch/inhibit/grant/restart handshakes,
and a separate bounded active-low HALT attachment adds 50,003 clocks and 784
