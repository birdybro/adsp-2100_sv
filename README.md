...
status/control/status-stack RTL slices, including the bounded MSTAT consumer
integration. Commands return nonzero on a real failure. Optional commands
report `SKIP` when their named tool is unavailable.
