...
selected-bank SR writeback, and bounded Type 17 internal-MOVE execution across
computational, DAG, status/control, PX, CNTR/count-stack, and SSTAT state.
OQ-016 narrow status reads and 18,432 unverified Type 15 subencodings remain
explicitly unresolved. Commands return
nonzero on a real
failure.
