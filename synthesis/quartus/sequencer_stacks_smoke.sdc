create_clock -name sequencer_stacks_clock -period 20.000 [get_ports {clk_i}]
...
set_input_delay -clock sequencer_stacks_clock -max 5.000 \
    [remove_from_collection [all_inputs] [get_ports {clk_i}]]
set_input_delay -clock sequencer_stacks_clock -min 5.000 \
    [remove_from_collection [all_inputs] [get_ports {clk_i}]]
set_output_delay -clock sequencer_stacks_clock 0.000 [all_outputs]
