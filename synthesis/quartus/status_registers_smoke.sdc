create_clock -name status_clock -period 20.000 [get_ports {clk_i}]
...
set_input_delay -clock status_clock -max 5.000 \
    [remove_from_collection [all_inputs] [get_ports {clk_i}]]
set_input_delay -clock status_clock -min 5.000 \
    [remove_from_collection [all_inputs] [get_ports {clk_i}]]
set_output_delay -clock status_clock 0.000 [all_outputs]
