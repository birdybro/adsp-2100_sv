...
directly tested at that owner. A fetched compute client and a single cache
shared by real Type 5/Type 13/fetch clients remain open, so this structural
extraction is not yet a unified core. A
